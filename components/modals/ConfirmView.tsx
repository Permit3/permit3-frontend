...
function ConfirmView(props: ConfirmViewProps) {
  ...
  return (
    <div className="flex flex-col p-8">
      <div className="text-center text-2xl font-quicksand font-bold opacity-80 leading-6">{title ?? "Error"}</div>
      {subtitle ? (
        <div className="text-center text-sm	font-quicksand font-semibold opacity-50 mt-2">{subtitle}</div>
      ) : null}
